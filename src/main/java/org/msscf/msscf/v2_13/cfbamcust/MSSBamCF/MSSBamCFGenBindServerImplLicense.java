...
public class MSSBamCFGenBindServerImplLicense
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindServerImplLicense() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalServerImplLicenseText();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::ServerImplLicense" );
