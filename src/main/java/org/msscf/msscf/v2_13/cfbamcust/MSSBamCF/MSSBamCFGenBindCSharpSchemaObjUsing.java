...
public class MSSBamCFGenBindCSharpSchemaObjUsing
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCSharpSchemaObjUsing() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalCsSchemaObjUsing();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CSharpSchemaObjUsing" );
