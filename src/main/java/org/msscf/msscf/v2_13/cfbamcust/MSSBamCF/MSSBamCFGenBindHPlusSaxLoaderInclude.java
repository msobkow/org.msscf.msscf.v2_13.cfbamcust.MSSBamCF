...
public class MSSBamCFGenBindHPlusSaxLoaderInclude
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindHPlusSaxLoaderInclude() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = table.getOptionalHppSaxLoaderInclude();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::HPlusSaxLoaderInclude" );
