...
public class MSSBamCFGenBindHPlusSaxLoaderEndElement
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindHPlusSaxLoaderEndElement() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = table.getOptionalHppSaxLoaderEndElement();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::HPlusSaxLoaderEndElement" );
