...
public class MSSBamCFGenBindCPlusXMsgRqstSchemaXsdElementList
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCPlusXMsgRqstSchemaXsdElementList() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalCppXMsgRqstSchemaXsdElementList();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CPlusXMsgRqstSchemaXsdElementList" );
