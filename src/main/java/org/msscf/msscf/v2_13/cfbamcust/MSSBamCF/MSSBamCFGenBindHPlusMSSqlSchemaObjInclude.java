...
public class MSSBamCFGenBindHPlusMSSqlSchemaObjInclude
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindHPlusMSSqlSchemaObjInclude() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalHppMSSqlSchemaObjInclude();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::HPlusMSSqlSchemaObjInclude" );
