...
public class MSSBamCFGenBindCPlusDb2LUWSchemaObjInclude
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCPlusDb2LUWSchemaObjInclude() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalCppDb2LUWSchemaObjInclude();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CPlusDb2LUWSchemaObjInclude" );
