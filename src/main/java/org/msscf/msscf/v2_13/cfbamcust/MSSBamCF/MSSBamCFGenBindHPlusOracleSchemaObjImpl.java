...
public class MSSBamCFGenBindHPlusOracleSchemaObjImpl
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindHPlusOracleSchemaObjImpl() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalHppOracleSchemaObjImpl();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::HPlusOracleSchemaObjImpl" );
