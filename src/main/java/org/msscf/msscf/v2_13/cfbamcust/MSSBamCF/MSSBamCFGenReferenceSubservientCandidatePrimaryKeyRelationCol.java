...
public class MSSBamCFGenReferenceSubservientCandidatePrimaryKeyRelationCol
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceSubservientCandidatePrimaryKeyRelationCol() {
		super();
	}
	...
	"ICFBamAtomObj, ICFBamTableColObj" );
		...
		try {
			ICFBamRelationColObj relcol = MSSBamCFAnyObj.derefSubservientCandidatePrimaryKeyRelationCol(focusDef);
			return( relcol );
		}
		catch (Throwable th) {
