...
public class MSSBamCFGenIterateId16Generators
	extends MssCFGenIteratorObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenIterateId16Generators() {
		super();
	}
