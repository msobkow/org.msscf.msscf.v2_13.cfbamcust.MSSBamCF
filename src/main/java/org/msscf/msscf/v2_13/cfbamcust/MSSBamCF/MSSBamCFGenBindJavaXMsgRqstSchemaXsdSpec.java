...
public class MSSBamCFGenBindJavaXMsgRqstSchemaXsdSpec
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindJavaXMsgRqstSchemaXsdSpec() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalJXMsgRqstSchemaXsdSpec();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::JavaXMsgRqstSchemaXsdSpec" );
