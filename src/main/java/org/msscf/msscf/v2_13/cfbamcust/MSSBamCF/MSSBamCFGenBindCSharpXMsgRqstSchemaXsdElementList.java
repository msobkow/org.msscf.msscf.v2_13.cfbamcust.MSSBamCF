...
public class MSSBamCFGenBindCSharpXMsgRqstSchemaXsdElementList
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCSharpXMsgRqstSchemaXsdElementList() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalCsXMsgRqstSchemaXsdElementList();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CSharpXMsgRqstSchemaXsdElementList" );
