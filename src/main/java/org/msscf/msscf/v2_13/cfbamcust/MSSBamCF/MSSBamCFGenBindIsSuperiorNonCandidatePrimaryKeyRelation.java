...
public class MSSBamCFGenBindIsSuperiorNonCandidatePrimaryKeyRelation
	extends MssCFGenBindObj
{
	@SuppressWarnings("unused")
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindIsSuperiorNonCandidatePrimaryKeyRelation() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		if( genDef instanceof ICFBamRelationObj ) {
			...
			if (isSuperiorNonCandidatePrimaryKeyRelation(relnToCheck)) {
				return( "yes" );
			}
			else {
				return( "no" );
	...
	public static boolean isSuperiorNonCandidatePrimaryKeyRelation( ICFBamRelationObj relnToCheck ) {
		if (relnToCheck == null) {
			return false;
		}
		if (!MSSBamCFGenBindIsSuperiorNonCandidateRelation.isSuperiorNonCandidateRelation(relnToCheck)) {
			return false;
		}
