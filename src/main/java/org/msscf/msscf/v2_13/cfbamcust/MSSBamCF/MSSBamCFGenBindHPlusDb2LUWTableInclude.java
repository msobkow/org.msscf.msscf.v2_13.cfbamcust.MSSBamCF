...
public class MSSBamCFGenBindHPlusDb2LUWTableInclude
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindHPlusDb2LUWTableInclude() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = table.getOptionalHppDb2LUWTableInclude();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::HPlusDb2LUWTableInclude" );
