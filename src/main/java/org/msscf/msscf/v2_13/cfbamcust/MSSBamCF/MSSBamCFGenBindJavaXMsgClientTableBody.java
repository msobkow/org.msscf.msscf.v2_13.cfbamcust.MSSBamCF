...
public class MSSBamCFGenBindJavaXMsgClientTableBody
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindJavaXMsgClientTableBody() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = table.getOptionalJXMsgClientTableBody();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::JavaXMsgClientTableBody" );
