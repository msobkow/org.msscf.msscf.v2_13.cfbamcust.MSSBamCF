...
public class MSSBamCFGenReferenceSubservientCandidateDataRelationCol
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceSubservientCandidateDataRelationCol() {
		super();
	}
	...
	"ICFBamAtomObj, ICFBamTableColObj" );
		...
		try {
			ICFBamRelationColObj relcol = MSSBamCFAnyObj.derefSubservientCandidateDataRelationCol(focusDef);
			return( relcol );
		}
		catch (Throwable th) {
