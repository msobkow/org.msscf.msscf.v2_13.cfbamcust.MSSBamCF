...
public class MSSBamCFGenBindHPlusXMsgRqstTableInclude
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindHPlusXMsgRqstTableInclude() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = table.getOptionalHppXMsgRqstTableInclude();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::HPlusXMsgRqstTableInclude" );
