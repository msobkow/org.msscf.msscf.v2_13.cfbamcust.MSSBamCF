...
public class MSSBamCFGenReferenceSuperiorNonCandidateRelationCol
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceSuperiorNonCandidateRelationCol() {
		super();
	}
	...
	"ICFBamAtomObj, ICFBamTableColObj" );
		...
		try {
			ICFBamRelationColObj relcol = MSSBamCFAnyObj.derefSuperiorNonCandidateRelationCol(focusDef);
			return( relcol );
		}
		catch (Throwable th) {
