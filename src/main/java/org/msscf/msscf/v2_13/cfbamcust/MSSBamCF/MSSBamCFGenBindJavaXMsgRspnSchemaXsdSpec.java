...
public class MSSBamCFGenBindJavaXMsgRspnSchemaXsdSpec
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindJavaXMsgRspnSchemaXsdSpec() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalJXMsgRspnSchemaXsdSpec();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::JavaXMsgRspnSchemaXsdSpec" );
