...
public class MSSBamCFGenBindJavaXMsgRspnSchemaXsdElementList
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindJavaXMsgRspnSchemaXsdElementList() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalJXMsgRspnSchemaXsdElementList();
