...
public class MSSBamCFGenReferenceFirstSuperiorNonCandidateRelationship
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceFirstSuperiorNonCandidateRelationship() {
		super();
	}
	...
	public ICFLibAnyObj dereference( MssCFGenContext genContext) {
		...
		return( MSSBamCFAnyObj.derefFirstSuperiorNonCandidateRelation(valueDef) );
	}
}
