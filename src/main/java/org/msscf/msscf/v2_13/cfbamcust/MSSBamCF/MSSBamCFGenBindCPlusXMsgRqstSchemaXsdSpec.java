...
public class MSSBamCFGenBindCPlusXMsgRqstSchemaXsdSpec
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCPlusXMsgRqstSchemaXsdSpec() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalCppXMsgRqstSchemaXsdSpec();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CPlusXMsgRqstSchemaXsdSpec" );
