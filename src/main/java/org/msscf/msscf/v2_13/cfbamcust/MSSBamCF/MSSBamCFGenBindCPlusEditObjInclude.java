...
public class MSSBamCFGenBindCPlusEditObjInclude
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCPlusEditObjInclude() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = table.getOptionalCppEditObjInclude();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CPlusEditObjInclude" );
