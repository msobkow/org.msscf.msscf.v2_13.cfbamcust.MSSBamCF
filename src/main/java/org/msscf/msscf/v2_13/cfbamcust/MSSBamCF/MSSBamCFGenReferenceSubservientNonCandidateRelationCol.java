...
public class MSSBamCFGenReferenceSubservientNonCandidateRelationCol
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceSubservientNonCandidateRelationCol() {
		super();
	}
	...
	"ICFBamAtomObj, ICFBamTableColObj" );
		...
		try {
			ICFBamRelationColObj relcol = MSSBamCFAnyObj.derefSubservientNonCandidateRelationCol(focusDef);
			return( relcol );
		}
		catch (Throwable th) {
