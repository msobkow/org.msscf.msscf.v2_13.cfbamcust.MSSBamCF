...
public class MSSBamCFGenBindCPlusMySqlTableInclude
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCPlusMySqlTableInclude() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = table.getOptionalCppMySqlTableInclude();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CPlusMySqlTableInclude" );
