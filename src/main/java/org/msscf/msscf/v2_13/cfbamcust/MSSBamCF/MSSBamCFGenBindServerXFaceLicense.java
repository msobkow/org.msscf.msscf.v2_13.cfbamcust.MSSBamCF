...
public class MSSBamCFGenBindServerXFaceLicense
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindServerXFaceLicense() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalServerXFaceLicenseText();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::ServerXFaceLicense" );
