...
public class MSSBamCFGenReferenceSuperiorPrimaryKeyRelationCol
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceSuperiorPrimaryKeyRelationCol() {
		super();
	}
	...
	"ICFBamAtomObj, ICFBamTableColObj" );
		...
		try {
			ICFBamRelationColObj relcol = MSSBamCFAnyObj.derefSuperiorPrimaryKeyRelationCol(focusDef);
			return( relcol );
		}
		catch (Throwable th) {
