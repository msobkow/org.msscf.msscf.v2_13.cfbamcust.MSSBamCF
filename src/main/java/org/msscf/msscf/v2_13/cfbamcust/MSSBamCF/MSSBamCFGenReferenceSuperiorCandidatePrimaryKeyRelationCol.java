...
public class MSSBamCFGenReferenceSuperiorCandidatePrimaryKeyRelationCol
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceSuperiorCandidatePrimaryKeyRelationCol() {
		super();
	}
	...
	"ICFBamAtomObj, ICFBamTableColObj" );
		...
		try {
			ICFBamRelationColObj relcol = MSSBamCFAnyObj.derefSuperiorCandidatePrimaryKeyRelationCol(focusDef);
			return( relcol );
		}
		catch (Throwable th) {
