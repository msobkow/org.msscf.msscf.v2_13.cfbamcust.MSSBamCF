...
public class MSSBamCFGenReferenceReverseRelationship
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceReverseRelationship() {
		super();
	}
	...
	public ICFLibAnyObj dereference( MssCFGenContext genContext) {
		...
		if (!(genDef instanceof ICFBamRelationObj)) {
			throw new CFLibUnsupportedClassException(getClass(), S_ProcName, "genContext", genDef, "ICFBamRelationObj");
		}
		ICFBamRelationObj relationDef = (ICFBamRelationObj)genDef;
		return( MSSBamCFAnyObj.derefReverseRelation(relationDef) );
	}
}
