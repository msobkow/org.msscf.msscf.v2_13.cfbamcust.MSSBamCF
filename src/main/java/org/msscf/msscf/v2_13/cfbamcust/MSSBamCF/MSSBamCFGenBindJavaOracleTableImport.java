...
public class MSSBamCFGenBindJavaOracleTableImport
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindJavaOracleTableImport() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = table.getOptionalJOracleTableImport();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::JavaOracleTableImport" );
