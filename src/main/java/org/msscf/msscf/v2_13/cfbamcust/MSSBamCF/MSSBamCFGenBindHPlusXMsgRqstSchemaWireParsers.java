...
public class MSSBamCFGenBindHPlusXMsgRqstSchemaWireParsers
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindHPlusXMsgRqstSchemaWireParsers() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalHppXMsgRqstSchemaWireParsers();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::HPlusXMsgRqstSchemaWireParsers" );
