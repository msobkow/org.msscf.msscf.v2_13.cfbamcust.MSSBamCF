...
public class MSSBamCFGenReferenceSuperiorCandidateDataRelationCol
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceSuperiorCandidateDataRelationCol() {
		super();
	}
	...
	"ICFBamAtomObj, ICFBamTableColObj" );
		...
		try {
			ICFBamRelationColObj relcol = MSSBamCFAnyObj.derefSuperiorCandidateDataRelationCol(focusDef);
			return( relcol );
		}
		catch (Throwable th) {
