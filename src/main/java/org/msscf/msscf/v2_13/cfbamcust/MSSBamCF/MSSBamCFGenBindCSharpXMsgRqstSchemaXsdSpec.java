...
public class MSSBamCFGenBindCSharpXMsgRqstSchemaXsdSpec
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCSharpXMsgRqstSchemaXsdSpec() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalCsXMsgRqstSchemaXsdSpec();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CSharpXMsgRqstSchemaXsdSpec" );
