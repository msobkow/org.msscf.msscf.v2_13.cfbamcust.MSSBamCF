...
public class MSSBamCFGenBindCPlusEditObjInterface
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCPlusEditObjInterface() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = table.getOptionalCppEditObjInterface();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CPlusEditObjInterface" );
