...
public class MSSBamCFGenBindHPlusXMsgRspnSchemaWireParsers
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindHPlusXMsgRspnSchemaWireParsers() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalHppXMsgRspnSchemaWireParsers();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::HPlusXMsgRspnSchemaWireParsers" );
