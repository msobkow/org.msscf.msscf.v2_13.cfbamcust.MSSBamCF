...
public class MSSBamCFGenReferenceSubservientNonCandidatePrimaryKeyRelationCol
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceSubservientNonCandidatePrimaryKeyRelationCol() {
		super();
	}
	...
	"ICFBamAtomObj, ICFBamTableColObj" );
		...
		try {
			ICFBamRelationColObj relcol = MSSBamCFAnyObj.derefSubservientNonCandidatePrimaryKeyRelationCol(focusDef);
			return( relcol );
		}
		catch (Throwable th) {
