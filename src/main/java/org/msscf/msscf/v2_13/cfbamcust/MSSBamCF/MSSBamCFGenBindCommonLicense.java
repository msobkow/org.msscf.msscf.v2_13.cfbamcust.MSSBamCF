...
public class MSSBamCFGenBindCommonLicense
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCommonLicense() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getRequiredCommonLicenseText();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CommonLicenseText" );
