...
public class MSSBamCFGenReferenceSubservientNonCandidateDataRelationCol
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceSubservientNonCandidateDataRelationCol() {
		super();
	}
	...
	"ICFBamAtomObj, ICFBamTableColObj" );
		...
		try {
			ICFBamRelationColObj relcol = MSSBamCFAnyObj.derefSubservientNonCandidateDataRelationCol(focusDef);
			return( relcol );
		}
		catch (Throwable th) {
