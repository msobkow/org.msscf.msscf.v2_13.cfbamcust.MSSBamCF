...
public class MSSBamCFGenReferenceSuperiorDataRelationCol
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceSuperiorDataRelationCol() {
		super();
	}
	...
	"ICFBamAtomObj, ICFBamTableColObj" );
		...
		try {
			ICFBamRelationColObj relcol = MSSBamCFAnyObj.derefSuperiorDataRelationCol(focusDef);
			return( relcol );
		}
		catch (Throwable th) {
