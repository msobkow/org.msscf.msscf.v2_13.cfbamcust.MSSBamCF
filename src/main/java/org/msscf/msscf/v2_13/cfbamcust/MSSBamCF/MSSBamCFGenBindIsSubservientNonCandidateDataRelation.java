...
public class MSSBamCFGenBindIsSubservientNonCandidateDataRelation
	extends MssCFGenBindObj
{
	@SuppressWarnings("unused")
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindIsSubservientNonCandidateDataRelation() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		if( genDef instanceof ICFBamRelationObj ) {
			...
			if (isSubservientNonCandidateDataRelation(relnToCheck)) {
				return( "yes" );
			}
			else {
				return( "no" );
	...
	public static boolean isSubservientNonCandidateDataRelation( ICFBamRelationObj relnToCheck ) {
		if (relnToCheck == null) {
			return false;
		}
