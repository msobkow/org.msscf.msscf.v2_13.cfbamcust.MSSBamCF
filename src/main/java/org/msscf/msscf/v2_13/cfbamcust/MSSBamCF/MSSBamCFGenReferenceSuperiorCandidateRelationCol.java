...
public class MSSBamCFGenReferenceSuperiorCandidateRelationCol
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceSuperiorCandidateRelationCol() {
		super();
	}
	...
	"ICFBamAtomObj, ICFBamTableColObj" );
		...
		try {
			ICFBamRelationColObj relcol = MSSBamCFAnyObj.derefSuperiorCandidateRelationCol(focusDef);
			return( relcol );
		}
		catch (Throwable th) {
