...
public class MSSBamCFGenReferenceSuperiorRelationCol
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceSuperiorRelationCol() {
		super();
	}
	...
	"ICFBamAtomObj, ICFBamTableColObj" );
		...
		try {
			ICFBamRelationColObj relcol = MSSBamCFAnyObj.derefSuperiorRelationCol(focusDef);
			return( relcol );
		}
		catch (Throwable th) {
