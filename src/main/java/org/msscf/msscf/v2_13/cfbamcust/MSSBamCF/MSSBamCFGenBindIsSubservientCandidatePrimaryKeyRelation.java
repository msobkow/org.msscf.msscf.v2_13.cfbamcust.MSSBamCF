...
public class MSSBamCFGenBindIsSubservientCandidatePrimaryKeyRelation
	extends MssCFGenBindObj
{
	@SuppressWarnings("unused")
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindIsSubservientCandidatePrimaryKeyRelation() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		if( genDef instanceof ICFBamRelationObj ) {
			...
			if (isSubservientCandidatePrimaryKeyRelation(relnToCheck)) {
				return( "yes" );
			}
			else {
				return( "no" );
	...
	public static boolean isSubservientCandidatePrimaryKeyRelation( ICFBamRelationObj relnToCheck ) {
		if (relnToCheck == null) {
			return false;
		}
