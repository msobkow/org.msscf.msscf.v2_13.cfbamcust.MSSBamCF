...
public class MSSBamCFGenBindCSharpSaxLoaderEndElement
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCSharpSaxLoaderEndElement() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = table.getOptionalCsSaxLoaderEndElement();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CSharpSaxLoaderEndElement" );
