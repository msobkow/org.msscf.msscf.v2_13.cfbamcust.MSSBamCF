...
public class MSSBamCFGenBindCPlusXMsgClientSchemaBody
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCPlusXMsgClientSchemaBody() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalCppXMsgClientSchemaBody();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CPlusXMsgClientSchemaBody" );
