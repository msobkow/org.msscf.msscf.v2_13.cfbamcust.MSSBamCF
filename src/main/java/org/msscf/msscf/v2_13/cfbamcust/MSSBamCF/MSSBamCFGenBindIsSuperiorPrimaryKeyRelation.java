...
public class MSSBamCFGenBindIsSuperiorPrimaryKeyRelation
	extends MssCFGenBindObj
{
	@SuppressWarnings("unused")
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindIsSuperiorPrimaryKeyRelation() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		if( genDef instanceof ICFBamRelationObj ) {
			...
			if (isSuperiorPrimaryKeyRelation(relnToCheck)) {
				return( "yes" );
			}
			else {
				return( "no" );
	...
	public static boolean isSuperiorPrimaryKeyRelation( ICFBamRelationObj relnToCheck ) {
		if (relnToCheck == null) {
			return false;
		}
