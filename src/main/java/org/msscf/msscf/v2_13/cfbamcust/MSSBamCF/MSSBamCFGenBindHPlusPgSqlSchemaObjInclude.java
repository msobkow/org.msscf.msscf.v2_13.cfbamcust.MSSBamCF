...
public class MSSBamCFGenBindHPlusPgSqlSchemaObjInclude
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindHPlusPgSqlSchemaObjInclude() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalHppPgSqlSchemaObjInclude();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::HPlusPgSqlSchemaObjInclude" );
