...
public class MSSBamCFGenBindCPlusXMsgRspnSchemaBody
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCPlusXMsgRspnSchemaBody() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalCppXMsgRspnSchemaBody();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CPlusXMsgRspnSchemaBody" );
