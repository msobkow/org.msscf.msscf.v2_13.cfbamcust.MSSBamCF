...
public class MSSBamCFGenBindCSharpXMsgRspnSchemaXsdSpec
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCSharpXMsgRspnSchemaXsdSpec() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalCsXMsgRspnSchemaXsdSpec();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CSharpXMsgRspnSchemaXsdSpec" );
