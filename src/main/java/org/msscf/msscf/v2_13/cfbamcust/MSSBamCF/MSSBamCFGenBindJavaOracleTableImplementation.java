...
public class MSSBamCFGenBindJavaOracleTableImplementation
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindJavaOracleTableImplementation() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = table.getOptionalJOracleTableImplementation();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::JavaOracleTableImplementation" );
