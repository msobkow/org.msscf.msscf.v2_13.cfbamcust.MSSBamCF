...
public class MSSBamCFGenBindClientImplLicense
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindClientImplLicense() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalClientImplLicenseText();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::ClientImplLicense" );
