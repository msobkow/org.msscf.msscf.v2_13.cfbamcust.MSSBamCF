...
public class MSSBamCFGenBindCSharpPgSqlSchemaObjImpl
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCSharpPgSqlSchemaObjImpl() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalCsPgSqlSchemaObjImpl();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CSharpPgSqlSchemaObjImpl" );
