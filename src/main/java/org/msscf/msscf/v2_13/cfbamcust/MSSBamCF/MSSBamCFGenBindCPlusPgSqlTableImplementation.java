...
public class MSSBamCFGenBindCPlusPgSqlTableImplementation
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCPlusPgSqlTableImplementation() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = table.getOptionalCppPgSqlTableImplementation();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CPlusPgSqlTableImplementation" );
