...
public class MSSBamCFGenBindClientXFaceLicense
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindClientXFaceLicense() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalClientXFaceLicenseText();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::ClientXFaceLicense" );
