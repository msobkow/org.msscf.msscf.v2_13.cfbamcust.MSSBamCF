...
public class MSSBamCFGenReferenceSubservientPrimaryKeyRelationCol
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceSubservientPrimaryKeyRelationCol() {
		super();
	}
	...
	"ICFBamAtomObj, ICFBamTableColObj" );
		...
		try {
			ICFBamRelationColObj relcol = MSSBamCFAnyObj.derefSubservientPrimaryKeyRelationCol(focusDef);
			return( relcol );
		}
		catch (Throwable th) {
