...
public class MSSBamCFGenBindHPlusXMsgRspnSchemaXsdElementList
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindHPlusXMsgRspnSchemaXsdElementList() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalHppXMsgRspnSchemaXsdElementList();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::HPlusXMsgRspnSchemaXsdElementList" );
