...
public class MSSBamCFGenBindCPlusXMsgRqstSchemaBody
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCPlusXMsgRqstSchemaBody() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalCppXMsgRqstSchemaBody();
		if( ( raw == null ) || ( raw.length() <= 0 ) ) {
			...
			execName.append( "::CPlusXMsgRqstSchemaBody" );
