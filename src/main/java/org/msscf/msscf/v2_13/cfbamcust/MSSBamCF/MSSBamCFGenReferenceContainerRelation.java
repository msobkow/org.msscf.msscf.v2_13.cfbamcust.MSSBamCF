...
public class MSSBamCFGenReferenceContainerRelation
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceContainerRelation() {
		super();
	}
	...
	public ICFLibAnyObj dereference( MssCFGenContext genContext) {
		...
		if (genDef instanceof ICFBamTableObj) {
			ret = MSSBamCFTableObj.getInheritedContainerRelation((ICFBamTableObj)genDef);
		}
		else {
