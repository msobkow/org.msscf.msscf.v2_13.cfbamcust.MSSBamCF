...
public class MSSBamCFGenIterateUuid6Generators
	extends MssCFGenIteratorObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenIterateUuid6Generators() {
		super();
	}
