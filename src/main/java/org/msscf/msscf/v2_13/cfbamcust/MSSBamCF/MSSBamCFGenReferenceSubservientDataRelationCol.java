...
public class MSSBamCFGenReferenceSubservientDataRelationCol
	extends MssCFGenReferenceObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenReferenceSubservientDataRelationCol() {
		super();
	}
	...
	"ICFBamAtomObj, ICFBamTableColObj" );
		...
		try {
			ICFBamRelationColObj relcol = MSSBamCFAnyObj.derefSubservientDataRelationCol(focusDef);
			return( relcol );
		}
		catch (Throwable th) {
