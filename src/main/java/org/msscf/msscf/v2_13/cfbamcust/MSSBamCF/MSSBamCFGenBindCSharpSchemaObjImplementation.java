...
public class MSSBamCFGenBindCSharpSchemaObjImplementation
	extends MssCFGenBindObj
{
	private static final long serialVersionUID = 1L;

	public MSSBamCFGenBindCSharpSchemaObjImplementation() {
		super();
	}
	...
	public String expandBody( MssCFGenContext genContext ) {
		...
		String ret;
		String raw = schemaDef.getOptionalCsSchemaObjImplementation();
